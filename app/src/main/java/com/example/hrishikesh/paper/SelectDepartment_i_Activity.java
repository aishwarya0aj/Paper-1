...
import com.example.hrishikesh.paper.I_Scheme.CivilSemesterList_i_Activity;
import com.example.hrishikesh.paper.I_Scheme.CompSemesterList_i_Activity;
import com.example.hrishikesh.paper.I_Scheme.EntcSemesterList_i_Activity;
import com.example.hrishikesh.paper.I_Scheme.ITSemesterList_i_Activity;
import com.example.hrishikesh.paper.I_Scheme.MechSemesterList_i_Activity;

public class SelectDepartment_i_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("I Scheme");
        setContentView(R.layout.activity_select_department_i_);

        /*Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Scheme I Departments");
        ...
        cv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), CompSemesterList_i_Activity.class);
                startActivity(i);
            }
        });
        cv2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), MechSemesterList_i_Activity.class);
                startActivity(i);
            }
        });
        cv3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), CivilSemesterList_i_Activity.class);
                startActivity(i);
            }
        });
        cv4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), EntcSemesterList_i_Activity.class);
                startActivity(i);
            }
        });
        cv5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), ITSemesterList_i_Activity.class);
                startActivity(i);
            }
        });
    }
